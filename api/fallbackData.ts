export type TableName = "experience" | "skills" | "projects";

export const fallbackTableData: Record<TableName, unknown[]> = {
  experience: [
    ...
    { id: 4, year: "2025 - 2026", title: "Treasuer", company: "Catholic Highschool Frateran Surabaya", tags: "Student Council" },
